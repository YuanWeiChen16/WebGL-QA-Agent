...
# Screenshots go to the session run dir (runs/<game>/<timestamp>/screenshots) via observe().
...
async def main():
    ...
    try:
        ...
        # Always leave a complete run (report.html + session.json), even on quit/Ctrl+C.
